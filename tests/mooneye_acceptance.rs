...
mod test {
    ...
    // #[test_case("boot_div-S.gb" ; "boot_div_s")] // only for sgb/sgb2
    // #[test_case("boot_div2-S.gb" ; "boot_div2_s")] // only for sgb/sgb2
    ...
    // #[test_case("boot_hwio-S.gb" ; "boot_hwio_s")] // only for sgb/sgb2
